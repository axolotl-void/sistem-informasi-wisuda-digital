...
export function ActivityTable() {
  return (
    ...
    >
      <div className="mb-5">
        <h2 className="text-2xl font-semibold tracking-tight text-white">Aktivitas Terkini</h2>
        <p className="text-sm font-medium text-white/35">Log scan kehadiran realtime</p>
      </div>
          ...
          <thead>
            <tr className="border-b border-white/[0.06]">
              {["Waktu", "Nama", "Kursi", "Gate", "Status"].map((h) => (
                <th
                  key={h}
                  className="pb-3 pr-4 text-left text-xs font-semibold tracking-wider text-white/25 uppercase last:pr-0"
                >
                  {h}
                </th>
              ))}
              ...
              return (
                ...
                >
                  <td className="py-3 pr-4">
                    <span className="font-mono text-xs tabular-nums text-white/40">{a.time}</span>
                  </td>
                  <td className="py-3 pr-4">
                    <span className="text-sm font-medium text-white/80">{a.name}</span>
                  </td>
                  <td className="py-3 pr-4">
                    <span className="rounded bg-white/[0.06] px-2 py-0.5 text-xs font-mono text-white/50">
                      {a.seat}
                    </span>
                  </td>
                  <td className="py-3 pr-4">
                    <span className="text-xs font-medium text-white/40">{a.gate}</span>
                  </td>
                  <td className="py-3">
